...
if(user.role=='admin'){
    ...
    const login_nav_mobile = document.getElementById('login_nav_mobile');
    login_nav.innerHTML = "Logout";
    login_nav_mobile.innerHTML = "Logout";
...
signup_button.addEventListener('click', () => {
    ...
    const signup_confirmPassword = document.getElementById('signup-confirmPassword').value;
